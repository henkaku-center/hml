...
## [Quick check — when does conjugacy *fail*?]{.lang-en}[クイックチェック — 共役性が*破綻*するのは?]{.lang-ja}
...
## [Quick check — answer]{.lang-en}[クイックチェック — 答え]{.lang-ja}
...
::: {.notes}
Land the nuance. This poll is genuinely ambiguous and that's deliberate — it
surfaces the difference between the textbook-strict definition (conjugate
to a SPECIFIC family) and the generalized fact (mixtures of conjugate priors
are themselves conjugate). Both readings are defensible; what matters is
that students see conjugacy as a property of the pair, not the prior alone.
If a student picked D, validate it — they read the question rigorously.
If they picked B, validate it — they generalized correctly. 1 min.
:::
