...
## [The reframe — likelihood ratio, not likelihood]{.lang-en}[再構築 — 尤度ではなく尤度比]{.lang-ja} {.bigger}

::: {.lang-en}
[Wrong question:]{.dim} "How likely is $x$ under randomness?"

[Right question:]{.accent} "How much *more* does $x$ favor randomness over a regular pattern?"
:::

::: {.lang-ja}
[誤った問い:]{.dim} 「$x$ はランダム下でどれくらい起こりやすいか?」

[正しい問い:]{.accent} 「$x$ は規則的パターンよりランダムをどれだけ*強く*支持するか?」
:::
...
::: {.lang-en}
[A **likelihood ratio** — with a uniform prior over the two hypotheses, this *is* the posterior odds.]{.yellow}
:::

::: {.lang-ja}
[**尤度比** — 2つの仮説に一様な事前を置けば、これがそのまま事後オッズ。]{.yellow}
:::
