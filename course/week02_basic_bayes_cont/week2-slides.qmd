...
Discrete joint  (Chibany's two meals):        two discrete vars.   Joint is a 4-cell table;  moves: marginalize, condition, check independence.

Discrete prior + continuous likelihood  (today's bento weight):        $H$ discrete, $D$ continuous.   Likelihood is a density;  prior stays discrete.

Continuous everywhere  (Gaussian-Gaussian):        $H$ continuous, $D$ continuous.   Prior, likelihood, posterior
...
[9 slots (Weeks 4–12). Pick your top-3 weeks on Slack #hml-2026 by Wed May 13.]{.dim}
