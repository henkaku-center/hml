...
**チバニー：  $\text{meal}_{\text{today}} \sim \mathrm{Bernoulli}(0.7)$。**
...
よって  $\mathbb{1}\{\text{meal} = \text{tonkatsu}\} \;\sim\; \mathrm{Bernoulli}(0.7)$。
...
::: {.lang-ja}
[**今日の観測：    $D = \text{weight} = 450$ g。**]{.yellow}

**$P(\text{meal} \mid \text{weight} = 450)$  はいくら？**
:::
...
|  | **週 + 話題** | **発表候補の一例** |
|:---|:---|:---|
| W4 (5/22) | 一般化 + 階層ベイズ | **Tenenbaum & Griffiths 2001** — ベイズ的一般化の定番 |
| W5 (5/29) | ベイジアンネット + 因果ベイジアンネット | **Gerstenberg et al 2015** — 反事実としての因果判断 |
| W6 (6/5) | マルコフ連鎖 + ネットワーク | **Abbott, Austerweil & Griffiths 2012** — ランダムウォークとしての記憶 |
| W7 (6/12) | モンテカルロ | **Vul et al 2009** — 認知における「1回きりのサンプリング」 |
| W8 (6/19) | SDT / MDP / RL | **Daw et al 2005** — モデルベース vs. モデルフリーの強化学習 |
| W9 (6/26) | 逆強化学習 + 社会的認知 | **Baker, Saxe & Tenenbaum 2009** — 行動理解を逆プランニングとして |
| W10 (7/3) | ベイジアンノンパラメトリクス | **Austerweil & Griffiths 2013** — IBP による特徴学習 |
| W11 (7/10) | 深層ニューラルネット + LLM | **Lake et al 2017** — 人間のように学習する機械を作る |
| W12 (7/17) | 倫理 + 敵対的機械学習 | **Caliskan et al 2017** — 単語埋め込みに現れる人間的バイアス |
