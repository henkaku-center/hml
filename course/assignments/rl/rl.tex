...
\begin{figure}[h]
\centerline{\includegraphics[width=2.6in]{figs/gardenpath}}
...
\end{itemize}
You can also experiment with both schemes, step by step, in the interactive
$Q$-learning widget embedded in textbook Chapter~22 (linked below).
...
\vspace{0.5em}
\noindent {\bf Prep reading.} Textbook Tutorial~3:
\href{https://josephausterweil.github.io/probintro/intro2/21_markov_decision_processes/}{Ch~21 (Markov Decision Processes)}
and
\href{https://josephausterweil.github.io/probintro/intro2/22_q_learning/}{Ch~22 (Q-Learning)},
including the live Q-learning widget. This assignment uses the same GardenPath
world and the same figures.

\section{Implement $Q$-learning}
In your stencil, fill in the one-line {\em prediction error} from
Equation~\eqref{eq:qlearn} (the term under the brace). All the setup --- the world,
...
only from samples. If we {\em know} the model (Chapter~21), we can compute the
