...
Building on an existing research project is okay — for example, applying a model from class to your own thesis data — as long as it is appropriate and your final paper is not identical to something you have submitted elsewhere (see the self-plagiarism note in the [syllabus](syllabus.html)).
...
See the [presentation guidelines](presentation-guidelines.html) for tips on giving an effective talk.
